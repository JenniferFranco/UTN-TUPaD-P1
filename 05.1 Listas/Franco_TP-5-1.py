...
# lista_multiplicos_4 = list( num for num in range(1,101) if num % 4 == 0 )
# print(lista_multiplicos_4)


#Resuelto manera tradicional
# lista_multiplicos_4 = []
# for num in range (1,101):
#     if num % 4 == 0:
#         lista_multiplicos_4.append(num)
# print(lista_multiplicos_4)        
...
# lista = [1, 'Jenni', 8.9, 4, 'Chau']
# print(lista[3])
# print(lista[-2]) #con números negativos
...
#Con max busca cual es el numero mas grande de la lista y con remove lo elimina

# 6) Crear una lista con números del 10 al 30 (incluído), haciendo saltos de 5 en 5 y mostrar por pantalla los dos primeros.

# lista = list(num for num in range(10,31,5) )
# print(lista[0:2])
